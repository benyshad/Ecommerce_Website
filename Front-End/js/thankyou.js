...
class UI {
  ...
  // static postShippingInfo() {
  //   let shippingInfo = JSON.parse(window.localStorage.getItem("shippingInfo"));
  //   const response = fetch("https://9ob4lub4d6.execute-api.us-east-1.amazonaws.com/default/get-shipping-info", {
  //     method: "POST",
...
class Storage {
  ...
  static clearLocalStorage() {
    ...
    localStorage.removeItem("cartCheckList");
